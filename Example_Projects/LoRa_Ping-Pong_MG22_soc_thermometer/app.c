...
static bool b_ping_pong_init = false;
static bool b_ping_pong_enabled = false;
...
SL_WEAK void app_process_action(void)
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  if ( b_ping_pong_enabled ) {
      if (b_ping_pong_init == false) {
          sl_status_t sc;
          b_ping_pong_init = true;
          ping_pong_init();
...
void sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_connection_opened_id:
      ...
      // Wait bt connection to start ping pong
      b_ping_pong_enabled = true;
